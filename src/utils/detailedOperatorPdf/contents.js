import { getEventAndFilters, getNames, getTable } from "./utils"
...
const content = (data) => {
  const { event, dateIni, dateEnd, users } = data
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            [
              {
                text: "RELATÓRIO DE VENDAS POR OPERADOR",
                style: "headerItem",
                fontSize: 11,
                bold: true,
              },

...
const releasePDF = (event, releases) => {
  pdfMake.vfs = pdfFonts.pdfMake.vfs

  const releasesList = releases.map((r) => [
    { text: firstCapital(r.operation), margin: [5, 0, 5, 0] },
    r.type,
    r.description,
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: "Tipo", style: "contentTableHeader" },
            { text: "Descrição", style: "contentTableHeader" },
            { text: "Taxa / Qnt", style: "contentTableHeader" },
            { text: "Valor", style: "contentTableHeader" },
          ],
          ...releasesList,
        ],
        widths: ["auto", "*", 200, 80, 70],
        columnGap: 10,
      },
      layout: "noBorders",
    },

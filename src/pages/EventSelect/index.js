...
import Api from '../../api';
import { selectEvent, loadEvents } from '../../action';
...
const EventSelect = ({ event, selectEvent, loadEvents }) => {
    ...
    <div className={styles.container}>
      ...
      >
        <Grid container justify='space-between' className={styles.nav}>
          ...
          <Grid item>
            <Button onClick={onLogout}  style={{ marginTop:'1rem', backgroundColor:"#00000000", color:'white' }}>Sair</Button>
          </Grid>
        </Grid>
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        <Grid container spacing={2}>
          <Grid item lg={12} md={12} sm={12} xs={12}>
            <Grid container spacing={2} style={{ backgroundColor: '#fff', borderRadius: '1.5rem', padding: '0.5rem' }}>
...
export default connect(mapStateToProps, { selectEvent, loadEvents })(EventSelect);
